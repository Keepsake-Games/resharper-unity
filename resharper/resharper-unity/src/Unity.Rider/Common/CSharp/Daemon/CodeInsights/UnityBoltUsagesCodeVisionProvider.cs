...
namespace JetBrains.ReSharper.Plugins.Unity.Rider.Common.CSharp.Daemon.CodeInsights
{
    ...
    public class UnityBoltUsagesCodeVisionProvider(ILazy<IActionManager> manager, ILazy<DataContexts> dataContexts)
        : ICodeInsightsProvider
    {
        ...
        public string ProviderId => "Bolt Usage";
        public string DisplayName => Strings.UnityBoltUsagesCodeVisionProvider_DisplayName_Unity_assets_usage;
        ...
        protected IconId IconId => InsightUnityIcons.InsightBolt.Id;
        ...
        private string GetText(int count, bool estimatedResult)
        {
            return NounUtilEx.ToEmptyPluralOrSingularQuick(count, estimatedResult,
                Strings.UnityBoltUsagesCodeVisionProvider_GetText_No_Bolt_usages,
                Strings.UnityBoltUsagesCodeVisionProvider_Noun_Bolt_usage,
                Strings.UnityBoltUsagesCodeVisionProvider_Noun_Bolt_usages);
        }
    }
}